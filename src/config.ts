...
export const siteConfig: SiteConfig = {
  title: 'Qianshi\'s Blog',
  subtitle: 'Blog Site',
  lang: 'zh_CN',         // 'en', 'zh_CN', 'zh_TW', 'ja', 'ko'
  themeColor: {
    hue: 331.58,         // Default hue for the theme color, from 0 to 360. e.g. red: 0, teal: 200, cyan: 250, pink: 345
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/qianshipoi/blogs',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    },
    {
      ...
      url: 'https://github.com/qianshipoi/blogs',
    },
  ],
}
